    ...
    return (
        ...
        <div className="right-bottom-section">
            <div className="other-line">
                ...
                {props.mzEntities && props.mzEntities.length > 0? <MzBlock array={props.mzEntities} exist={props.mzEntities.length > 0} /> : ""}
            </div>
        </div>
        ...
        <TableRow style={{borderBottom: 'hidden'}}>
            ...
            <Collapse in={open} timeout="auto" unmountOnExit>
                ...
                <Table size="small" aria-label="purchases">
                    <TableHead>
                        <TableRow style={{borderBottom: 'hidden'}}>
                            <TableCell style={{ width: '30%', fontSize: '12px', color: "#6D6D6D" }}  align="left"><a>Статус минздрава</a></TableCell>
